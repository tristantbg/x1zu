module.exports = function(grunt) {
    grunt.initConfig({
        concat: {
            plugins: {
                src: ['lib/lazysizes/lazysizes.min.js', 'lib/lazysizes/plugins/optimumx/ls.optimumx.min.js', 'lib/viewport-units-buggyfill/viewport-units-buggyfill.js', 'lib/history.js/scripts/bundled/html4+html5/jquery.history.js'],
